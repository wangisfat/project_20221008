...
import com.wdyVBlog.common.exception.UtilException;
...
import com.wdyVBlog.common.utils.file.FileTypeUtils;
import com.wdyVBlog.common.utils.file.FileUtils;
import com.wdyVBlog.common.utils.file.ImageUtils;
import com.wdyVBlog.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    public Cell addCell(Excel attr, Row row, T vo, Field field, int column)
    {
        ...
        try
        {
            ...
            if (attr.isExport())
            {
                ...
                {
                    cell.setCellValue(Convert.toStr(dataFormatHandlerAdapter(value, attr)));
                }
                else
                {
                    // 设置列类型
     ...
     * @return
     */
    public Object dataFormatHandlerAdapter(Object value, Excel excel)
    {
        try
        {
