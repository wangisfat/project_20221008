...
import com.wdyVBlog.common.utils.file.FileUploadUtils;
import com.wdyVBlog.common.utils.file.FileUtils;
import com.wdyVBlog.framework.config.ServerConfig;
...
public class CommonController
{
    ...
    public void fileDownload(String fileName, Boolean delete, HttpServletResponse response, HttpServletRequest request)
    {
        try
        {
            ...
            String filePath = WdyVBlogConfig.getDownloadPath() + fileName;
    ...
    public AjaxResult uploadFile(MultipartFile file) throws Exception
    {
        ...
        {
            // 上传文件路径
            String filePath = WdyVBlogConfig.getUploadPath();
            // 上传并返回新文件名称
