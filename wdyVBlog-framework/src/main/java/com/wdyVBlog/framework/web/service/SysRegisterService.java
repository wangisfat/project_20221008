...
import com.wdyVBlog.common.core.domain.model.RegisterBody;
//import com.wdyVBlog.common.core.redis.RedisCache;
import com.wdyVBlog.common.exception.user.CaptchaException;
import com.wdyVBlog.common.exception.user.CaptchaExpireException;
...
//        redisCache.deleteObject(verifyKey);
        ...
        String captcha = String.valueOf(EhcacheUtil.getCacheObject(verifyKey));
        EhcacheUtil.deleteObject(captcha);
        if (captcha == null)
        {
