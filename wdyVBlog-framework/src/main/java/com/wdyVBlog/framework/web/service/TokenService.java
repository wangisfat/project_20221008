...
//                LoginUser user = redisCache.getCacheObject(userKey);
                LoginUser user = (LoginUser) EhcacheUtil.getCacheObject(userKey);
                return user;
            }
            catch (Exception e)
            {
...
//            redisCache.deleteObject(userKey);
            EhcacheUtil.deleteObject(userKey);
        }
    }
...
//        redisCache.setCacheObject(userKey, loginUser, expireTime, TimeUnit.MINUTES);
        EhcacheUtil.setCacheObject(userKey, loginUser, expireTime * 60 * 60);
    }
